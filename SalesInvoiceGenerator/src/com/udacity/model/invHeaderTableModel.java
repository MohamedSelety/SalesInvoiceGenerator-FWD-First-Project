...
public class invHeaderTableModel extends AbstractTableModel {   
    ...
    private List<InvoFrame1>invoicesArray;
    private DateFormat df = new SimpleDateFormat("dd-MM-yyyy");
    public invHeaderTableModel(List<InvoFrame1>invoicesArray) {
...
return invoicesArray.size();
 ...
 public List<InvoFrame1> getInvoicesArray() {
...
@Override
   ...
   @Override
    public Object getValueAt(int rowIndex, int columnIndex) {
        InvoFrame1 row =invoicesArray.get(rowIndex);
        switch(columnIndex){
