...
private InvoFrame1 header;

    public InvoiceLine(String itemName, double itemPrice, int itemCount, InvoFrame1 header) {
    ...
    public InvoFrame1 getHeader() {
        return header;
    }

    public void setHeader(InvoFrame1 header) {
        this.header = header;
    }
